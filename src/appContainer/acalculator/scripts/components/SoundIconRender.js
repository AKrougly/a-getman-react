...
export default function () {
  return (
    <div muted={this.props.muted} >
      <svg xmlns="http://www.w3.org/2000/svg" fill="rgba(31, 37, 37, 0)" onClick={this.onClick.bind(this)} className={this.getMutedCss(this.props.muted)} viewBox="0 0 43.54 40">
